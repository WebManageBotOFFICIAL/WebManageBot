...
client.on("guildChannelTopicUpdate", async (message, channel, oldTopic, newTopic) => {
...
client.on("guildChannelPermissionsUpdate", async (message, channel, oldPermissions, newPermissions) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
client.on("unhandledGuildChannelUpdate", async (message, oldChannel, newChannel) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
client.on("guildMemberBoost", async (message, member) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Member Unboosted
client.on("guildMemberUnboost", async (message, member) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Member Got Role
client.on("guildMemberRoleAdd", async (message, member, role) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Member Lost Role
client.on("guildMemberRoleRemove", async (message, member, role) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Nickname Changed
client.on("guildMemberNicknameUpdate", async (message, member, oldNickname, newNickname) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Member Joined
client.on("guildMemberEntered", async (message, member) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
client.on("guildBoostLevelUp", async (message, guild, oldLevel, newLevel) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
client.on("guildBoostLevelDown", async (message, guild, oldLevel, newLevel) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Banner Added
client.on("guildBannerAdd", async (message, guild, bannerURL) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// AFK Channel Added
client.on("guildAfkChannelAdd", async (message, guild, afkChannel) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Guild Vanity Add
client.on("guildVanityURLAdd", async (message, guild, vanityURL) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Guild Vanity Remove
client.on("guildVanityURLRemove", async (message, guild, vanityURL) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
client.on("guildVanityURLUpdate", async (message, guild, oldVanityURL, newVanityURL) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
client.on("rolePositionUpdate", async (message, role, oldPosition, newPosition) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
client.on("rolePermissionsUpdate", async (message, role, oldPermissions, newPermissions) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Avatar Updated
client.on("userAvatarUpdate", async (message, user, oldAvatarURL, newAvatarURL) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Username Updated
client.on("userUsernameUpdate", async (message, user, oldUsername, newUsername) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
client.on("userDiscriminatorUpdate", async (message, user, oldDiscriminator, newDiscriminator) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Flags Updated
client.on("userFlagsUpdate", async (message, user, oldFlags, newFlags) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Joined VC
client.on("voiceChannelJoin", async (message, member, channel) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// Left VC
client.on("voiceChannelLeave", async (message, member, channel) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// VC Switch
client.on("voiceChannelSwitch", async (message, member, oldChannel, newChannel) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// VC Mute
client.on("voiceChannelMute", async (message, member, MuteType) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// VC Unmute
client.on("voiceChannelUnmute", async (message, member, MuteType) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// VC Defean
client.on("voiceChannelDeaf", async (message, member, deafType) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
// VC Undefean
client.on("voiceChannelUndeaf", async (message, member, deafType) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
...
client.on("voiceStreamingStart", async (message, member, voiceChannel) => {
	const channelName = idConfig.logOldChannelName;
	const LogChannel = message.guild.channels.cache.find(ch => ch.name(channelName));
